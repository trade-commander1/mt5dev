...
input int         InpMinLen  = 5;               // Min MA Period
input int         InpMaxLen  = 200;             // Max MA Period
...
void SetBuffer(int idx, int bar, double val)
{
    switch (idx)
    {
        ...
        case 4: Buffer4[bar] = val; break;
        case 5: Buffer5[bar] = val; break;
        case 6: Buffer6[bar] = val; break;
        case 7: Buffer7[bar] = val; break;
        case 8: Buffer8[bar] = val; break;
        case 9: Buffer9[bar] = val; break;
    }
}
...
int OnInit()
{
    ...
    SetIndexBuffer(8, Buffer8, INDICATOR_DATA);
    SetIndexBuffer(9, Buffer9, INDICATOR_DATA);
    ...
    IndicatorSetString(INDICATOR_SHORTNAME,
        "tcMABundle10(" + IntegerToString(minLen) + "-" + IntegerToString(maxLen) + ")");
