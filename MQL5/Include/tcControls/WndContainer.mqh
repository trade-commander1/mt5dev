...
public:
   ...
   bool ZOrder(int zorder) ;
   bool InBackground(bool bInBackground);
protected:
...
bool CWndContainer::BringToTop(void)
{
   if(!IS_VISIBLE)
      return(false);
   bool bret=true;
   ...
   for(int i=total-1;i>=0;i--)
     {
      ...
      if(control==NULL)
         continue;
      bret &= control.BringToTop();
     }
//--- call of the method of the parent class
   return bret;
}
  
bool CWndContainer::ZOrder(int zorder)
{
   if(!IS_VISIBLE)
      return(false);
   bool bret=true;
   ...
   for(int i=total-1;i>=0;i--)
     {
      ...
      if(control==NULL)
         continue;
      bret &= control.ZOrder(zorder);
     }
//--- call of the method of the parent class
   return bret;
}

bool CWndContainer::InBackground(bool bInBackground)
{
   if(!IS_VISIBLE)
      return(false);
   bool bret=true;
   ...
   for(int i=total-1;i>=0;i--)
     {
      ...
      if(control==NULL)
         continue;
      bret &= control.InBackground(bInBackground);
     }
//--- call of the method of the parent class
   return bret;
}
