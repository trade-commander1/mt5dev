...
public:
   ...
   bool              SetFont(const string value,const int size);
   bool              ReadOnly(void) const {return m_ReadOnly;}
   void              ReadOnly(bool x) {m_ReadOnly=x;m_edit.ReadOnly(x);}
   
   color              Color(void) const {return m_edit.Color();}
   void               Color(color x){m_edit.Color(x);}
   
   color              ColorBackground(void) const {return m_edit.ColorBackground();}
   void               ColorBackground(color x){m_edit.ColorBackground(x);}
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
CDatePicker::CDatePicker(void) : m_value(0),m_ReadOnly(false)
  {
  }
//+------------------------------------------------------------------+
//| Destructor                                                       |
...
//+------------------------------------------------------------------+
bool CDatePicker::Font(const string value)
{
   return m_edit.Font(value);
}
//+------------------------------------------------------------------+
//| Set the "Font size" parameter                                    |
//+------------------------------------------------------------------+
bool CDatePicker::FontSize(const int value)
{
   return m_edit.FontSize(value);
}

//+------------------------------------------------------------------+
//| Set the "Font  and font size" parameter                                    |
//+------------------------------------------------------------------+  
bool  CDatePicker::SetFont(const string value,const int size)
{
   return m_edit.SetFont(value,size);
}  
