...
public:
   // ce   
   bool              ZOrder(int xzorder);
   bool              InBackground(bool background);
   


   inline long ChartID(void) {return m_chart_id;}
protected:
...
//| Set ZOrder                             |
//+------------------------------------------------------------------+
bool   CWnd::ZOrder(int xzorder)
{
   return ObjectSetInteger(m_chart_id,m_name,OBJPROP_ZORDER,xzorder);
}
bool   CWnd::InBackground(bool bbackground)
{
   return ObjectSetInteger(m_chart_id,m_name,OBJPROP_BACK,bbackground);
}
